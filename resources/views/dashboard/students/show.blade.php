...
@section('page-title', $student->first_name)
      ...
      <div class="col-lg-4">
        <div class="card" style="width: 30rem;">
          ...
          <ul class="list-group list-group-flush" >
            <li class="list-group-item font-weight-bolder"><span class="font-weight-bold">First Name: </span>{{$student->first_name}}</li>
          ...
          <div class="card-footer">
            <p class="text-center font-weight-bold">Student classes</p>
            <table class="table">
              <thead>
                <tr>
                  <th scope="col">NO:</th>
      ...
      <div class="col-lg-4">
        <div class="card" style="width: 24rem;">
          @if ($student->images()->exists())
            <img src="{{asset('storage/images/' . $student->images->first()->file_name)}}" class="card-img-top" alt="...">
          @else
